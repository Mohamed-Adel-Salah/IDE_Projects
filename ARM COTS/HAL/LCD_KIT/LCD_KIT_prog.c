...
{
	DIO_voidSetPinDirection(LCD_ADDRESS_PORT,LCD_ADDRESS_E,Output_Push_Pull_Mode);
	DIO_voidSetPinDirection(LCD_ADDRESS_PORT,LCD_ADDRESS_RS,Output_Push_Pull_Mode);

	DIO_voidSetPinDirection(LCD_DATA_PORT,LCD_DATA_PinD4,Output_Push_Pull_Mode);
	DIO_voidSetPinDirection(LCD_DATA_PORT,LCD_DATA_PinD5,Output_Push_Pull_Mode);
	DIO_voidSetPinDirection(LCD_DATA_PORT,LCD_DATA_PinD6,Output_Push_Pull_Mode);
	DIO_voidSetPinDirection(LCD_DATA_PORT,LCD_DATA_PinD7,Output_Push_Pull_Mode);
